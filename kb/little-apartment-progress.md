...
- [x] **Docs** — logged here; mines perf note + Map/fast-travel feature idea added to kb; games.md synced (achievement count 33, phone app list, ending removed, weather section).
