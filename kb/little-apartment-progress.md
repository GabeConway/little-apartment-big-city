...
- [x] **Docs** — logged here; mines perf note + Map/fast-travel feature idea added to kb; games.md synced (35 achievements, 19 scenes, phone app list incl. Almanac, ending removed, weather + new-systems blocks).
