...
export const GAME_ACHIEVEMENTS: GameAchievement[] = [
  ...
  { id: 'ghost-in-the-machine', title: 'Ghost in the Machine', desc: 'Met the man in the grey hoodie.', hint: 'The Manager has one secret left, and it is a name — behind a door that is not in the cave yet.' },
