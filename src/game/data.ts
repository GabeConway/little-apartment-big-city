...
export const GAME_ACHIEVEMENTS: GameAchievement[] = [
  ...
  { id: 'bon-voyage', title: 'Bon Voyage', desc: 'Reached Paris.', hint: 'Somebody has to move you there. Find out who.' },
  { id: 'ghost-in-the-machine', title: 'Ghost in the Machine', desc: 'Something in a server closet knew your real name for it.', hint: 'The Manager has one secret left — behind a door that is not in the sea cave yet.' },
