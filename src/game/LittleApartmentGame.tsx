...
// scale with accuracy.
//
// AUDIO: the song IS the minigame. A dedicated 45s cut — "Midnight Neon"
// (intro → first chorus → verse, faded) — plays from 0:00 while
...
const KARAOKE_CHART: number[] = [
  ...
  29.33, 29.80, 30.26, 31.19, 32.12, 33.98, 34.91, 36.77, 37.23, 37.70, 38.63,
  40.95, 41.42, 41.88, 42.81,
];
