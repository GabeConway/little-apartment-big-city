...
const shrine: SceneDef = {
  ...
  warps: [
    { x: 9, y: 10, to: 'city', tx: 24, ty: 12, dir: 'down' },
    { x: 10, y: 10, to: 'city', tx: 25, ty: 12, dir: 'down' },
  ],
...
const paris: SceneDef = {
  ...
  // Door back to the backrooms seam. Arrival in Paris (the hacker transition lands
  // the player at tile 12,8) sits far from this door so neither warp bounces.
  warps: [
...
export const SCENES: Record<string, SceneDef> = {
  apartment, city, denden, konbini, pawn, shore, badtown, nightclub, garage, gacha, backrooms, mines, shrine, island, deepsea, paris,
};
